...
class TestEncryptedCSVExtractable(unittest.TestCase):
    ...
    def test_encrypted_csv_is_extractable(self):
        ...
        self.assertTrue("kfcH/5QhDIoNXMhd1wT5zW4B6mE6AvVPPiaysNYvnPfw" in ledger)
        ...
        self.assertFalse("kfcH/5QhDIoNXMhd1wT5zW4B6mE6AvVPPiaysNYvnPfw" in csv)

        # Clean up
        os.remove("triages.csv")


class TestEncryptedCSVNotExtractable(unittest.TestCase):
    def setUp(self):
        pass
    
    def test_encrypted_csv_is_not_extractable_wrong_key(self):
        DOWNLOAD_CSV = "triage_as_downloaded.csv"
        LEDGER_FILENAME = "triages.dcl"
        SKF = "secret_triages_corrupt.dcs"
        CSV_FILENAME = "triages.csv"
        ...
        self.assertTrue("9i-oz4E5IHU" in csv)
        self.assertFalse("7541760303" in csv)
        self.assertFalse("Jensen" in csv)
        self.assertTrue("kfcH/5QhDIoNXMhd1wT5zW4B6mE6AvVPPiaysNYvnPfw" in csv)
